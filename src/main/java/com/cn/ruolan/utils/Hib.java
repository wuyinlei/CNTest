...
public class Hib {
    ...
    public static void init(){
        ...
        final StandardServiceRegistry registry = new StandardServiceRegistryBuilder()
                ...
                .build();
        try {
            sSessionFactory = new MetadataSources(registry).buildMetadata().buildSessionFactory();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static void initOld() {
        try {
            ...
            //第三步:创建会话工厂
            sSessionFactory = configuration.buildSessionFactory(standardServiceRegistry);
        } catch (Throwable ex) {
